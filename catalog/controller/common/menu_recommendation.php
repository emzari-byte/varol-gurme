...
'second_drink' => !empty($recommendation['second_drink']) ? $recommendation['second_drink'] : null
	...
	private function generateAiText($context) {
		...
		if ($is_english) {
			$system_prompt = 'You are a restaurant recommendation assistant for Varol Gurme. Write short, natural, friendly and menu-appropriate English copy.';
			$prompt = '
You are a restaurant recommendation assistant for Varol Gurme.
...
';
			...
			$prompt = '
Sen Varol Gurme için çalışan bir restoran öneri asistanısın.
