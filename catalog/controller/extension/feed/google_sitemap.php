...
class ControllerExtensionFeedGoogleSitemap extends Controller {
	public function index() {
		...
		$output .= $this->buildUrl($this->url->link('common/home', '', true), 'daily', '1.0');
		$output .= $this->buildUrl($this->url->link('common/menu', '', true), 'daily', '1.0');
		$output .= $this->buildUrl($this->url->link('common/menu_recommendation', '', true), 'weekly', '0.8');
	...
	private function buildUrl($loc, $changefreq = 'weekly', $priority = '0.7', $lastmod = '') {
		$output = '<url>';
		$output .= '<loc>' . htmlspecialchars($loc, ENT_XML1, 'UTF-8') . '</loc>';
