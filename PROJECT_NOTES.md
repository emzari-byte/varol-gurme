...
```text
/home/varolgur/public_html/menumen
```
...
- `restaurant_akinsoft_bridge_url` should be `https://varolgurme.com/menumen/`.
...
```text
/home/varolgur/public_html/Api/WebEnt9
```
