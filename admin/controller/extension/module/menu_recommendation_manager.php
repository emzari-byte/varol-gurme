...
class ControllerExtensionModuleMenuRecommendationManager extends Controller {
	...
	public function index() {
		...
		$data['pair_tags'] = array(
			array('value' => 'breakfast', 'text' => $this->language->get('text_pair_breakfast')),
			array('value' => 'soup',      'text' => $this->language->get('text_pair_soup')),
			array('value' => 'meat',      'text' => $this->language->get('text_pair_meat')),
			array('value' => 'comfort',   'text' => $this->language->get('text_pair_comfort')),
			array('value' => 'fresh',     'text' => $this->language->get('text_pair_fresh')),
			array('value' => 'sweet',     'text' => $this->language->get('text_pair_sweet')),
			array('value' => 'hot',       'text' => $this->language->get('text_pair_hot')),
			array('value' => 'cold',      'text' => $this->language->get('text_pair_cold')),
			array('value' => 'general',   'text' => $this->language->get('text_pair_general'))
		);
